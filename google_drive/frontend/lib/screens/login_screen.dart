...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // Future<void> _handleSignInDebug() async {
  //   try {
  ...
  void handleLogin() async {
    DialogUtils.showLoadingDialog(context, 'Signing in with Google...');
    // showDialog(
    //   context: context,
    ...
    // print('****************started signin');

    // Add debug call here
    // await _handleSignInDebug();
